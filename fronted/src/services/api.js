...
export async function getDepartures({ date, type, airlineId, search, locationSearch } = {}) {
  return apiFetch(`/flights/departures${buildQuery({ date, type, airlineId, search, locationSearch })}`);
}

export async function getArrivals({ date, type, airlineId, search, locationSearch } = {}) {
  return apiFetch(`/flights/arrivals${buildQuery({ date, type, airlineId, search, locationSearch })}`);
}
